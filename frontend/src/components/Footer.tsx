      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 text-sm text-muted sm:px-6 lg:grid-cols-4 lg:px-8">
        <div className="flex flex-col gap-4">
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-2.5 text-xs text-foreground backdrop-blur-md transition-all duration-300 hover:border-primary/40 hover:bg-primary/10">
            ...
            >
              <span className="font-bold text-foreground">Made in Berlin</span>
              <svg viewBox="0 0 24 24" width="15" height="15" fill="currentColor" className="inline-block text-foreground transition-transform hover:scale-110">
              ...
              <span>— Nichts zu verstecken — auch nicht im Code</span>
            </a>
          </div>
