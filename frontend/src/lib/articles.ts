...
export const articles: Article[] = [
  ...
  {
    slug: "nvidia-blackwell-ultra-rollout",
    title: "NVIDIA startet Auslieferung der Blackwell-Ultra-Generation an Hyperscaler",
    summary:
      "Die nächste Iteration der Blackwell-Architektur verspricht deutlich höhere Inferenz-Durchsatzraten pro Watt und soll die Nachfrage der großen Cloud-Anbieter für 2026/27 bedienen.",
    categorySlug: "hardware",
    tags: ["NVIDIA", "Blackwell", "Data Center"],
  ...
  {
    slug: "amd-instinct-mi350-benchmark",
    title: "AMD Instinct MI350: Erste unabhängige Benchmarks gegen NVIDIAs Blackwell",
    summary:
      "Neue Vergleichstests zeigen AMDs MI350-Beschleuniger bei bestimmten Inferenz-Workloads konkurrenzfähig, bei Software-Reife (ROCm-Ökosystem) bleibt weiterhin ein Rückstand zu CUDA sichtbar.",
    categorySlug: "hardware",
    tags: ["AMD", "ROCm", "Benchmark"],
    sourceName: "AMD ROCm Blog",
    sourceUrl: "https://rocm.docs.amd.com/",
    publishedAt: "2026-07-30",
    aiGenerated: true,
    humanReviewed: false,
  },
  {
    slug: "juelich-jupiter-exascale-vollbetrieb",
    title: "JUPITER in Jülich erreicht vollen Exascale-Betrieb",
    summary:
      "Europas erster Exascale-Supercomputer am Forschungszentrum Jülich ist vollständig in Betrieb und steht KI-Forschungsprojekten aus ganz Europa über die EuroHPC JU zur Verfügung.",
    categorySlug: "hardware",
    tags: ["Supercomputing", "EuroHPC", "Deutschland"],
    sourceName: "Forschungszentrum Jülich",
    sourceUrl: "https://www.fz-juelich.de/de/ias/jsc/jupiter",
    publishedAt: "2026-07-29",
    aiGenerated: true,
    humanReviewed: true,
    editorsPick: true,
    editorsNote:
      "Zeigt konkret, was europäische Souveränität bei KI-Infrastruktur praktisch bedeutet – relevant für alle, die über Cloud-Abhängigkeiten von US-Anbietern nachdenken.",
  },
  {
    slug: "asml-euv-lithografie-naechste-generation",
    title: "ASML kündigt nächste EUV-Lithografie-Generation für KI-Chip-Fertigung an",
    summary:
      "Die neue High-NA-EUV-Generation soll kleinere Strukturbreiten ermöglichen und ist damit ein Schlüsselfaktor für zukünftige NVIDIA-, AMD- und TSMC-Chipgenerationen.",
    categorySlug: "hardware",
    tags: ["ASML", "Lithografie", "Supply Chain"],
    sourceName: "ASML",
  ...
  {
    slug: "desktop-ai-rigs-kosten-nutzen-2026",
    title: "Desktop-AI-Rigs 2026: Wann lohnt sich eigene Hardware gegenüber Cloud-APIs?",
    summary:
      "Eine aktualisierte Kosten-Nutzen-Rechnung vergleicht Anschaffungskosten für lokale Dev-Rigs mit Unified-Memory-Architekturen gegen laufende Cloud-API-Kosten bei 70B- und 120B-Modellen.",
    categorySlug: "hardware",
    tags: ["Dev-Rigs", "TCO", "Apple Silicon"],
    sourceName: "AIActEU Redaktion",
    sourceUrl: "https://developer.nvidia.com/embedded-computing",
    publishedAt: "2026-07-24",
    aiGenerated: false,
    humanReviewed: true,
  },
  ...
  {
    slug: "eu-carbon-leakage-ki-rechenzentren-studie",
    title: "Umweltbundesamt warnt vor Carbon Leakage durch KI-Rechenzentrumswachstum",
    summary:
      "Eine neue UBA-Studie zeigt: Weil KI-Rechenkapazitäten stark auf die USA und China konzentriert sind, könnte ein EU-CO2-Preis Rechenlast eher verlagern als reduzieren.",
    categorySlug: "nachhaltigkeit",
    tags: ["Carbon Leakage", "Rechenzentren", "Umweltbundesamt"],
    ...
    editorsPick: true,
    editorsNote:
      "Zeigt, dass der ökologische Fußabdruck von KI längst eine handfeste EU-Politikfrage ist – nicht nur ein technisches Detail.",
  },
  {
    slug: "kuerzere-prompts-weniger-energieverbrauch",
    title: "Neue Untersuchung: Kürzere Prompts und Outputs senken den Energieverbrauch von KI spürbar",
    summary:
      "Forschende der UNU-INWEH zeigen, dass Modellwahl, Prompt-Länge und Modalität den ökologischen Fußabdruck von KI-Nutzung ebenso beeinflussen wie die Infrastruktur dahinter.",
    categorySlug: "nachhaltigkeit",
    tags: ["Green AI", "Energieverbrauch", "UNU-INWEH"],
    sourceName: "UNU-INWEH",
    sourceUrl: "https://unu.edu/inweh/",
    publishedAt: "2026-07-28",
    aiGenerated: true,
    humanReviewed: false,
  },
  {
    slug: "telekom-gruene-ki-rechenzentrum-ausbau",
    title: "Deutsche Telekom baut Kühlungssteuerung ihrer Rechenzentren mit KI weiter aus",
    summary:
      "Nach den 2024 vorgestellten Grundsätzen für grüne KI setzt der Konzern nun stärker auf KI-gesteuerte Kühlung und bedarfsgerechtes Abschalten von Mobilfunk-Antennen.",
    categorySlug: "nachhaltigkeit",
    tags: ["Deutsche Telekom", "Green AI", "Data Center"],
    sourceName: "Deutsche Telekom",
    sourceUrl: "https://www.telekom.com/",
    publishedAt: "2026-07-20",
    aiGenerated: true,
    humanReviewed: false,
  },
  {
    slug: "ki-diagnostik-uniklinik-pilotprojekt",
    title: "Deutsche Uniklinik startet Pilotprojekt für KI-gestützte Röntgenbild-Diagnostik",
    summary:
      "Ein Radiologie-Team testet ein KI-Modell zur Voranalyse von Röntgenaufnahmen als Zweitmeinung – die finale Diagnose bleibt beim ärztlichen Personal.",
    categorySlug: "applications",
    tags: ["Healthcare", "Diagnostik", "Enterprise-Integration"],
    sourceName: "Ärzteblatt",
  ...
  {
    slug: "generative-ai-marketing-mittelstand-studie",
    title: "Wie deutsche Mittelständler generative KI im Marketing einsetzen",
    summary:
      "Eine Branchenumfrage zeigt: Bildgenerierung und Textentwürfe sind im Marketing-Alltag angekommen, echte Kampagnen-Automatisierung bleibt aber die Ausnahme.",
    categorySlug: "applications",
    tags: ["Marketing", "Mittelstand", "Creative AI"],
    sourceName: "Bitkom",
    sourceUrl: "https://www.bitkom.org/",
    publishedAt: "2026-07-21",
    aiGenerated: true,
    humanReviewed: false,
  },
  {
    slug: "consumer-app-alltagsassistent-update",
    title: "Verbreiteter KI-Alltagsassistent bekommt Update für Termin- und Reiseplanung",
    summary:
      "Die neue Version verknüpft Kalender, E-Mails und Buchungsportale, um mehrstufige Planungsaufgaben eigenständig zu erledigen – vorerst nur auf Englisch.",
    categorySlug: "applications",
    tags: ["Consumer AI", "Assistenten", "Alltag"],
  ...
  {
    slug: "ki-konferenz-muenchen-programm-2026",
    title: "KI-Konferenz München kündigt Programm mit Fokus auf Open-Source-Ökosystem an",
    summary:
      "Neben internationalen Speakern legt die Konferenz diesmal einen Schwerpunkt auf deutsche und europäische Open-Source-Initiativen und Networking-Formate.",
    categorySlug: "community",
    tags: ["Konferenz", "Open Source", "Deutschland"],
    sourceName: "KI-Konferenz München",
    sourceUrl: "https://www.digitalevents.de/",
    publishedAt: "2026-07-30",
    aiGenerated: false,
    humanReviewed: true,
  },
  {
    slug: "dach-ai-hackathon-herbst-2026",
    title: "DACH-weiter KI-Hackathon ruft zu Projekten für den öffentlichen Sektor auf",
    summary:
      "Teams aus Deutschland, Österreich und der Schweiz entwickeln 48 Stunden lang Open-Source-Prototypen für Verwaltung, Bildung und Gesundheitswesen.",
    categorySlug: "community",
    tags: ["Hackathon", "Open Source", "DACH"],
    sourceName: "Gründerszene",
    sourceUrl: "https://www.gruenderszene.de/",
    publishedAt: "2026-07-18",
    aiGenerated: true,
  ...
  {
    slug: "lokale-ki-meetups-netzwerk-wachstum",
    title: "Lokale KI-Meetup-Netzwerke wachsen: Über 40 aktive Gruppen im deutschsprachigen Raum",
    summary:
      "Von Berlin bis Zürich treffen sich Entwickler:innen und Forschende regelmäßig zu Vorträgen und Coding-Sessions – die Szene organisiert sich zunehmend über offene Plattformen.",
    categorySlug: "community",
    tags: ["Meetups", "Community", "Networking"],
    sourceName: "Meetup",
  ...
  {
    slug: "red-teaming-bericht-frontier-modelle",
    title: "Neuer Red-Teaming-Bericht deckt Schwachstellen in mehreren Frontier-Modellen auf",
    summary:
      "Externe Sicherheitsforscher:innen dokumentieren systematisch, unter welchen Bedingungen sich Sicherheitsmaßnahmen aktueller Modelle umgehen lassen, und empfehlen strengere Evaluationsstandards.",
    categorySlug: "safety",
    tags: ["Red Teaming", "Model Evaluation", "AI Safety"],
    sourceName: "METR",
  ...
  {
    slug: "bias-mitigation-neue-benchmark-suite",
    title: "Neue Benchmark-Suite soll Bias in mehrsprachigen KI-Modellen systematisch messbar machen",
    summary:
      "Das Testset deckt Geschlechter-, Herkunfts- und Altersbias über zehn Sprachen hinweg ab und soll Modellvergleiche für Unternehmen und Regulierer erleichtern.",
    categorySlug: "safety",
    tags: ["Bias", "Fairness", "Benchmark"],
  ...
  {
    slug: "nist-ai-rmf-adoption-deutsche-unternehmen",
    title: "Immer mehr deutsche Unternehmen orientieren sich am NIST AI Risk Management Framework",
    summary:
      "Trotz fehlender rechtlicher Pflicht nutzen Compliance-Abteilungen das US-Framework zunehmend als praktische Vorlage für internes KI-Risikomanagement neben dem EU AI Act.",
    categorySlug: "safety",
    tags: ["AI Risk Management", "Governance", "Compliance"],
    sourceName: "NIST",
